...
//  10685703
//
//  Created by Debrah Andrew Kwadwo  on 10/12/2018.
...
using namespace std;
int main()
{ int edStaffL=0,stdMenu=0,editS,editS1,p=0,mm=0,h=0,e,del,z=0,x=0, i=0,r=0,cNo[10],print,addStaff=0,v0=0, eSLoop=0;
    ...
    while(p<=100)
    {
        ...
        {system("color 7C");
            system("cls");
            cout<<"Enter 1 to add a new student and assign courses.\n";
            cout<<"Enter 2 to edit a student and courses.\n";
            cout<<"Enter 3 to delete a student from the records.\n";
            cout<<"Enter 4 to print the Academic record of a student.\n";
